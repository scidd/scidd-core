...
description = ("A Python package for implementing the SciDD data identification scheme and resolving data.")
...
exec(open('scidd/core/version.py').read())
setup(
	name = "scidd_core",
	...
	packages=setuptools.find_namespace_packages(include=[f"scidd.*"]), # scidd uses native namespaces; see: https://packaging.python.org/guides/packaging-namespace-packages/#native-namespace-packages
	zip_safe=False,
