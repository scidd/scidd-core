...
expected_results_galex_sciid_to_url = [
	...
	("sciid:/astro/file/galex/gr6/MISDR1_24279_0266_0001-nd-cat_mch_rtastar.fits",
...
def test_galex_resolve_filenames(temporary_cache, sci_id, url):
	'''
...
@pytest.mark.parametrize("sci_id, url", expected_results_galex_sciid_to_url)
def test_galex_download_files(temporary_cache, sci_id, url):
	'''
